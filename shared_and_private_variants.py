...
if (len(clonal_frequencies) > 0):
	...
	out_fig = parent_dir + "_rep1_clonal_freqiencies.png"
	...
	out_fig = parent_dir + "_rep1_clonal_freqiencies_lowVAF.png"
	plt.savefig(out_fig , dpi=500 , format='png')
...
if (len(clonal_frequencies) > 0):
	...
	out_fig = parent_dir + "_rep2_clonal_freqiencies.png"
	plt.savefig(out_fig , dpi=500 , format='png')
	...
	out_fig = parent_dir + "_rep2_clonal_freqiencies_lowVAF.png"
	plt.savefig(out_fig , dpi=500 , format='png')
